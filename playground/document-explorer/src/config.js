System.config({
  ...
  paths: {
    "npm:*": "playground/document-explorer/jspm_packages/npm/*",
    "github:*": "playground/document-explorer/jspm_packages/github/*",
    "app/*": "playground/document-explorer/src/*",
    "carbon/*": "dist/js/*"
  },
